...
export const page: PageType = {
  ...
  ten: {
    title: "Para quem é esse treinamento",
    description: "Para quem é o Reset Empreendedor",
    sections: [
      {
        subdescription: "É para você que...",
        bullets: {
          itemsPerColumn: 3,
          variant: "check" as const,
          items: [
      ...
      {
        subdescription: "Não é pra você que...",
        bullets: {
          itemsPerColumn: 2,
          variant: "x" as const,
          items: [
  ...
  twelve: {
    title: "Última chance de entrar nesta condição",
    description:
